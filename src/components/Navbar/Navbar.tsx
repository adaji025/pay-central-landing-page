...
import WaitlistModal from "../_shared/WaitlistModal";
...
const Navbar = () => {
  ...
  return (
    <Fragment>
      ...
      <div className="z-[10]  w-full fixed top-[56px] bg-white">
        <nav className={`px-5 lg:px-12 max-w-[1440px] ${styles.navbarItems}`}>
          ...
          <button
            className="py-2 px-5 border max-w-[180px] w-full text-sm hidden lg:flex justify-center items-center"
            onClick={open}
          >
